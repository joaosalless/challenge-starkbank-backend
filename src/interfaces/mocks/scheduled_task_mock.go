...
// Source: ./src/interfaces/scheduled_task.go
...
func (m *MockScheduledTask) Schedule() error {
	m.ctrl.T.Helper()
...
func (mr *MockScheduledTaskMockRecorder) Schedule() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Schedule", reflect.TypeOf((*MockScheduledTask)(nil).Schedule))
}
