...
func (m *MockInvoiceHandler) InvoiceHookProcess(ctx *gin.Context) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "InvoiceHookProcess", ctx)
}

// InvoiceHookProcess indicates an expected call of InvoiceHookProcess.
func (mr *MockInvoiceHandlerMockRecorder) InvoiceHookProcess(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InvoiceHookProcess", reflect.TypeOf((*MockInvoiceHandler)(nil).InvoiceHookProcess), ctx)
}
